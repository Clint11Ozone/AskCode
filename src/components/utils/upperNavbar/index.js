...
function Index({ handlePrev, handleNext, slideIndex = 0, slides }) {
    return (
        <>
            <div className='h-[3rem] border-b flex flex-row items-center justify-between px-[1rem]'>
               {slideIndex != 0 && <Image src={back} height={30} width={30} onClick={handlePrev}/>}
                <Image src={allplansLogo} height={30} width={120} />
                <div className='flex flex-row items-center gap-[1rem]'>
                    <Image src={refresh} height={30} width={30} />
                    <Image src={help} height={30} width={30} />
                </div>
