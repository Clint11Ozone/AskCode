...
const Navbar = ({ handlePrev, handleNext, slideIndex = 0, slides }) => {
  ...
  return (
    <footer className=" w-full p-10 justify-center">
      <div className="flex justify-center space-x-4 max-w-[40rem] mx-auto">
        <button
          className={`bg-[#5253F1] text-white py-[1rem] lg:py-[1.5rem] px-4 rounded-full h-[60px] w-[340px] flex items-center justify-center ${isButtonDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
